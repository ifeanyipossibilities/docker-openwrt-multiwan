...
This package was forked from [github](https://github.com/oofnikj/docker-openwrt) i added reboot support and ability to add mwan3 load balancing and fall over
